...
# based on https://github.com/noyoshi/prettycli, but since I don't want dependencies... added here

class AbstractColorClass:
    def __init__(self, base_code=0, codes=None):
...
class ExampleClass(AbstractColorClass):
    """
    ...
    def copy(self):
        return ExampleClass(self.base_code, list(self.codes), self.string)
    ...
    def __str__(self):
        ...
        # if this fails... I am going to assume we are in a jupyter notebook?
        try:
...
# These are the ExampleClass objects to export!

# Normal Foreground Codes
black = ExampleClass(30)
red = ExampleClass(31)
green = ExampleClass(32)
yellow = ExampleClass(33)
blue = ExampleClass(34)
magenta = ExampleClass(35)
cyan = ExampleClass(36)
white = ExampleClass(37)

# Bright Foreground Codes
bright_black = ExampleClass(90)
bright_red = ExampleClass(91)
bright_green = ExampleClass(92)
bright_yellow = ExampleClass(93)
bright_blue = ExampleClass(99)
bright_magenta = ExampleClass(95)
bright_cyan = ExampleClass(96)
bright_white = ExampleClass(97)

# Styles
bold = ExampleClass(1)
italics = ExampleClass(3)
underline = ExampleClass(4)
color = ExampleClass(0)
crossed = ExampleClass(9)
